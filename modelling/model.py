...
def custom_scaled_dot_product_attention(
    ...
    attn_weight = torch.nn.functional.dropout(attn_weight, dropout_p, training=True)
...
class Attention(nn.Module):
    def __init__(self, args: ModelArgs):
        ...
        self.last_attn_weights = (
            None  # instance variable to store last computed attention weights
        )
    ...
    def forward(
        ...
        if self.flash:
            output, scores = custom_scaled_dot_product_attention(
                xq,
                xk,
                xv,
                attn_mask=None,
        ...
        self.last_attn_weights = scores.detach()  # store the scores
